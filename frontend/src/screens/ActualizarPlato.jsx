...
const ActualizarPlato=()=>{
    ...
    const handleSubmitForm=async(e)=>{
        ...
        try{
            const{data}=await axios.put("http://localhost:3000/api/platos/actualizar",{
                idPlato,
                color,
                precio,
                nombre,
            ...
            toast("Actualizacion exitosa",{
                type:"success"
            })
        }catch(err){
            toast("No se encontro el plato",{
                type:"error"
            })
        }
    ...
    return (
        <div>
            ...
            <form className="form-add-plato" onSubmit={handleSubmitForm}>
                ...
                <button>Actualizar plato</button>
            </form>
